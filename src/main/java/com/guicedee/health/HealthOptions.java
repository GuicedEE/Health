 ...
 *
 * <p>This annotation can be placed on a configuration class or a package to customize the health check
...
public @interface HealthOptions {
     ...
     *
     * <p>If set to {@code false}, health checks will not be registered and the HTTP endpoints will not be exposed.
     ...
     *
     * <p>This endpoint provides a summary of all registered health checks (liveness, readiness, and startup).
     ...
     *
     * <p>Liveness checks indicate whether the application is alive and should be restarted if it fails.
     ...
     *
     * <p>Readiness checks indicate whether the application is ready to receive traffic.
     ...
     *
     * <p>Startup checks indicate whether the application has successfully started up.
